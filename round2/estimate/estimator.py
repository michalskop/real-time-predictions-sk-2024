...
# 04/2024:
interval_parameters = [{'a': 0.07281116510186401,
  'b': 0.023336591425291757,
  'c': -1.8922196322738953,
  'max': 20,
  'min': 0},
 {'a': 0.021573988292109714,
  'b': 0.003489028005279307,
  'c': -0.13782424551081696,
  'max': 60,
  'min': 20},
 {'a': 0.011872215932488684,
  'b': 0.004061356171795571,
  'c': -0.04367532075944308,
  'max': 90,
  'min': 60},
 {'a': 0.005332323753837131,
  'b': 0.0060102586545479515,
  'c': -0.012868191677889058,
  'max': 99,
  'min': 90},
 {'a': 0.0014188490595349256,
  'b': 0.03870688205718948,
  'c': -0.0059506364210190656,
  'max': 100,
  'min': 99}]
...
# set to the real results for counted == 100
if counted == 100:
  results_rich['hi'] = results_rich['result']
  results_rich['lo'] = results_rich['result']
