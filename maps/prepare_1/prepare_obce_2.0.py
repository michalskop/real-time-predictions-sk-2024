...
fname2 = "PREZ2024_kolo1_SK_tab02e.csv"
...
df_data2 = pd.read_csv(path + "prepare_1/" + fname2)
...
df_points.to_csv(path + "obce_points-1_votes.csv", index=False)
df_regions.to_csv(path + "obce_regions-1_votes.csv", index=False)