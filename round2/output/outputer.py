...
# prepare output json
output = {
  "info": "REAL RESULTS! Godspeed to the model 2!",
  "datetime": datetime.datetime.now().isoformat(timespec='seconds'),
  "datetime-model": df_info[df_info['name'] == 'estimating_president_2024-2'].iloc[-1]['value'],
  "datetime-data": df_info[df_info['name'] == 'prez2024_med_kan_okr'].iloc[-1]['value'],
  "counted": round(float(df_info[df_info['name'] == 'counted_president_2024-2'].iloc[-1]['value']), 2),
  "candidates": []
}
